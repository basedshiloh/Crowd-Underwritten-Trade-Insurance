  ...
  return (
    <section className="py-28">
      <div className="main-container">
        <div className="mx-auto mb-[70px] max-w-[720px] space-y-5 text-center">
        ...
        <RevealAnimation delay={0.4}>
          <div>
            <Accordion
              ...
              {faqData.map((item) => (
                <AccordionItem
                  className="dark:bg-background-7 border-stroke-1 dark:border-stroke-8 rounded-[20px] border bg-white px-6 md:px-8"
                  key={item.id}
