...
const TopNavHeading = () => {
  ...
  if (!showTopNavDescription) {
    return null;
  }

  return (
    <RevealAnimation delay={0.1} direction="up" instant>
      <div className="bg-ns-cyan absolute top-0 left-0 z-50 w-full px-5 py-1.5">
        <div className="relative flex items-center justify-between">
          <figcaption className="text-secondary text-tagline-2 md:text-tagline-2 font-inter-tight text-left leading-[150%] font-normal">
          ...
          <button onClick={() => setShowTopNavDescription(false)} className="size-5 cursor-pointer md:size-6">
