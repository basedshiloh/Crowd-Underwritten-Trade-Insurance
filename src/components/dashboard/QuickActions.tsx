      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {actions.map(({ icon, title, description, href }) => (
          <Link
            key={href}
            href={href}
            className="group flex gap-4 rounded-xl border border-stroke-5 bg-background-4 p-4 transition-colors hover:border-primary-500/30 hover:bg-primary-500/5 dark:border-stroke-6 dark:bg-background-9 dark:hover:border-primary-500/30 dark:hover:bg-primary-500/10"
          >
