...
export type CreateCoverageState = { ok: true; requestId: string; requiredHoldPercent: number } | { ok: false; error: string };

export async function createCoverageAction(_prev: CreateCoverageState | null, formData: FormData): Promise<CreateCoverageState> {
