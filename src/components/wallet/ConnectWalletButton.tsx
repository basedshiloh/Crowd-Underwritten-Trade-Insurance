  ...
  return (
    <div
      ...
      <div className="relative">
        {/* Visible layer: same structure as LinkButton, purple (btn-primary-v2) */}
        <div
          className="pointer-events-none mx-auto inline-flex h-12 w-full cursor-pointer items-center justify-center gap-1.5 rounded-full text-center font-medium lowercase text-nowrap transition-all duration-500 ease-in-out md:mx-0 md:h-auto md:w-auto btn-xl-v2 !border-0 btn-primary-v2"
          aria-hidden>
